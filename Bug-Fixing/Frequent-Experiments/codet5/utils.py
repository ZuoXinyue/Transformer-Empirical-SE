...
def get_filenames(data_root, task, sub_task, split='', args=None):
    if task == 'refine':
        ...
        # train_fn = '{}/train.bugfix.buggy,{}/train.bugfix.fixed'.format(data_dir, data_dir)
        # dev_fn = '{}/valid.bugfix.buggy,{}/valid.bugfix.fixed'.format(data_dir, data_dir)
        # test_fn = '{}/test.bugfix.buggy,{}/test.bugfix.fixed'.format(data_dir, data_dir)
    if split == 'train':
        return train_fn
    elif split == 'dev':
        return dev_fn
